...
<body data-ctrl=true style="background:#f8f8f8;">
    ...
    <div class="infoBox">
        ...
        <div class="ele" style="line-height: 50px;height:50px;">
            <span style="vertical-align: middle;margin-left:3px;">洛克云ID：</span>
            <input type="text" value="" placeholder="洛克云ID" style="border:none;color:;#bcbcbc;" id="describe">
        </div>       
		<div class="line" style="margin-right: 10px;"></div>
		<div class="ele" style="line-height: 50px;height:50px;">
            <span style="vertical-align: middle;margin-left:3px;">洛克云手机号：</span>
            <input type="text" value="" placeholder="洛克云手机号" style="border:none;color:;#bcbcbc;" id="describe">
        </div> 
    </div>
